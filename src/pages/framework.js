...
export const FrameworkPageTemplate = ({sections}) => {
  return(
    <div>
...
const FrameworkPage = ({data}) => {
  ...
  return(
    ...
    >
      ...
      />
      <FrameworkPageTemplate sections={sectionData} />
    </Layout>
  )
}
...
export const frameworkPageQuery = graphql`{
  allKontentItemApplicationPages(filter: {fields: {slug: {eq: "framework"}}}) {
    nodes {
      elements {
        menu_title {
          value
